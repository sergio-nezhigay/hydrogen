...
export const filledStar = <Star fill="yellow" strokeWidth={0} />;
export const halfFilledStar = <StarHalf fill="yellow" strokeWidth={0} />;
export const star = <Star fill="#d3d3d3" strokeWidth={0} />;
      ...
      <div className="relative">
        <div className="inline-flex gap-0.5">
          {Array.from({length: 5}, (_, index) => (
            <Star fill="#d3d3d3" strokeWidth={0} key={index} />
          ))}
        </div>
